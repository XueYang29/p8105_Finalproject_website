...
maternal_age_plot_data %>%
  ...
  mutate(percent = number/ sum(number)) %>%
  plot_ly(x = ~year, y = ~percent, color = ~new_age, type = "scatter", 
          mode = "lines+markers", colors = "Set1"
          ) %>% 
  layout(xaxis = list(title = " Year"),
         yaxis = list(title = "Proportion of number of  birth"),
         legend = list(title = "Maternal Age"))
```
